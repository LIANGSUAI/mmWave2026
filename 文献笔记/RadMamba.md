...
经过前三步，原本大而笨重的雷达图，已经被压成了一根又细又长、且富含物理意义的（1D Sequence）。这时候，Mamba 登场了。它通过前面提到的“选择性扫描（Selective Scan）”，把1D Sequence里代表“走路”、“跌倒”的黄金片段记住，把“静止不动”的废料扔掉。最后送入 Linear 层输出概率。
